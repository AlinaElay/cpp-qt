...
namespace {
struct qt_meta_tag_ZN8SelectorE_t {};
} // unnamed namespace

template <> constexpr inline auto Selector::qt_create_metaobjectdata<qt_meta_tag_ZN8SelectorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_btn_cart_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btn_clear_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pb_fruit_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pb_vegetable_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pb_drink_clicked'
    ...
    return QtMocHelpers::metaObjectData<Selector, qt_meta_tag_ZN8SelectorE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Selector::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8SelectorE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8SelectorE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN8SelectorE_t>.metaTypes,
    nullptr
} };
...
void *Selector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8SelectorE_t>.strings))

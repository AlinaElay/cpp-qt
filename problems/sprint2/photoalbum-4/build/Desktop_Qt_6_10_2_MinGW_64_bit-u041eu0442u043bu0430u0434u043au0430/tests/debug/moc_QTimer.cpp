...
template <> constexpr inline auto prac::QTimer::qt_create_metaobjectdata<qt_meta_tag_ZN4prac6QTimerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QTimer, qt_meta_tag_ZN4prac6QTimerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject prac::QTimer::staticMetaObject = { {
    QMetaObject::SuperData::link<::QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4prac6QTimerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4prac6QTimerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN4prac6QTimerE_t>.metaTypes,
    nullptr
} };
...
void prac::QTimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (QTimer::*)()>(_a, &QTimer::timeout, 0))
            return;
    }
}
...
void *prac::QTimer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4prac6QTimerE_t>.strings))

    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->action_up_windows, &QAction::triggered, this, &MainWindow::UpWindowsSlot);
    connect(ui->action_use_resources, &QAction::triggered, this, &MainWindow::UseResourcesSlot);
    connect(ui->action_choose_dir, &QAction::triggered, this, &MainWindow::ChooseDirSlot);
}
...
void MainWindow::UseResourcesSlot() {
    SetFolder(":/cats/images/");
}

void MainWindow::ChooseDirSlot() {
